...
export const mcpApi = {
  ...
  connect: (name) =>
    api.post("/mcp/connect", { name }),

  disconnect: (name) =>
    api.post("/mcp/disconnect", { name }),

  refresh: () =>
    api.post("/mcp/refresh"),
};
...
export const visionApi = {
  ...
  history: () =>
    api.get("/vision/history"),

  deleteImage: (id) =>
    api.delete(`/vision/image/${id}`),
